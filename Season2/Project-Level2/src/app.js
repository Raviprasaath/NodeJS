...
app.post("/login", async (req, res) => {
    try {
        ...
        // the below instaed of writing here we can write this in user.js file
        ...
        if (isPasswordValid) {
            ...
            // the below commented code is correct only but best way of writing code is instead of writing this here,
            // we can write this in models/user 
